...
<section id="sobre">
    <div class="sobre">
		...
		<h1>A King Burger</h1>
		<p class="center descricao">
			<br>
			Fundado em 1954,possui mais de 15 mil lojas, servindo mais de 11 milhões de consumidores por dia em mais de 100 países ao redor do mundo!
		</p>
    </div>
</section>
</main>
...
<footer>
		...
		<p class="center">
			Desenvolvido pelo Mestre dos magos.
		</p>
</footer>
