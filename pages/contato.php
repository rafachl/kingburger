...
<section class="contato">
    ...
    <div  class="itemForm">
        ...
        <select><option value="" selected="selected">- Selecionar -</option><option value="phone">Telefone</option><option value="email">Mail</option><option value="no">Carta</option></select>
    </div>
    <div  class="itemForm">
